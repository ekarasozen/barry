...
grid.shiftstack("ttgridfile.npy","before_ts_wfs.mseed","lonlatgridfile.npy",1)                 
#plot.plotGrid("lonlatgridfile.npy","stacked_strengthfile.npy")
#rec.plotRecordSection("before_ts_wfs.mseed","best_stack_wfs.mseed","stafile.csv","stacked_locfile.csv")
