...
#grid.makestalist("AK","BAE,BAT,FID,GHO,GLI,KNK,M23K,PWL,RC01,SAW,SCM,VMT","BHZ","*","2021-08-09 07:43:00") 
#grid.creategrid(-150.0,-147.0,0.1,59,62,0.1,3.5,"stafile.csv")
#grid.prepwaveforms("stafile.csv","2021-08-09 07:43:00",360)  
#grid.locate("ttgridfile.npy","before_ts_wfs.mseed","lonlatgridfile.npy",4)                 
